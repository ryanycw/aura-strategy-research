...
const contractFile = require("../import/abi/BaseRewardPool4626.json");
const depositList = require("../import/allOther-depositList.json")
...
async function main() {
    ...
    reward = await factory.attach(process.env.STETH_REWARD_CONTRACT_MAINNET);
    ...
    fs.writeFileSync('./out/auraB-stETH-STABLE-vault.json', JSON.stringify(result));
}
